...
window.ZoiaPatch = require('./src/ZoiaPatch');

},{"./src/ZoiaPatch":5,"buffer":3}],2:[function(require,module,exports){
'use strict'
...
const getStringAt = (buff, n, len = 1) =>
    buff.slice(n * BYTE_STRIDE, (n * BYTE_STRIDE) + (len * BYTE_STRIDE)).toString().replace(/[^\x00-\x7F]/g, '').replace(/\0/g, '');
...
},{"../taxonomy/patch.json":8,"./modules":6,"buffer":3}],6:[function(require,module,exports){
module.exports = {
    ...require('./interface')
};

},{"./interface":7}],7:[function(require,module,exports){
/*
 *
